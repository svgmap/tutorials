...
To see the actual operation, click on [geojson1.html](https://svgmap.org/examples/tutorials/geojson1/geojson1.html).

### File Structure {#file-structure}

- [Tutorial 6 directories](https://svgmap.org/examples/tutorials/geojson1/)
...
- [Click here](https://svgmap.org/examples/tutorials/geojson1/geojson1.html) to see how it works.
- The file used is a [ZIP archive file](https://www.svgmap.org/examples/tutorials/geojson1.zip).
