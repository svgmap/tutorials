...
It is essentially the same as [tutorial2b.html](../tutorial-2b/index.md#tutorial2bhtml) used in [Tutorial 2b](../tutorial-2b/index.md).

### Container.svg {#container-svg}

- It is essentially the same as [Container.svg](../tutorial-2b/index.md#containersvg) from [Tutorial 2b](../tutorial-2b/index.md).
